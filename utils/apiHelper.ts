...
const CONDENSE_PROMPT = `Given the following conversation and a follow up question, craft in Albanian language the follow up question to be a standalone question.
...
const QA_PROMPT_COMMON = `Dua që të veprosh si një asistent për produkte të pkatformes e-albania 
